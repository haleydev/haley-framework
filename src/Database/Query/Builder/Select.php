...
class Select extends Syntax
{
     ...
     */
    public function from(string $table, null|string $as = null)
    {
        $this->add('table', [
            'table' => $table,
            'as' => $as
     ...
     */
    public function columnRaw(string $raw, array $bindparams = [])
    {
        $this->add('columns', [
            'type' => 'column_raw',
            'raw' => $raw,
     ...
     */
    public function columnCount(string $column, null|string $as = null)
    {
        $this->add('columns', [
            'type' => 'column_count',
            'column' => $column,
     ...
     */
    public function columnAvg(string $column, null|string $as = null)
    {
        $this->add('columns', [
            'type' => 'column_avg',
            'column' => $column,
     ...
     */
    public function columnSum(string $column, null|string $as = null)
    {
        $this->add('columns', [
            'type' => 'column_sum',
            'column' => $column,
     ...
     */
    public function columnMin(string $column, null|string $as = null)
    {
        $this->add('columns', [
            'type' => 'column_min',
            'column' => $column,
     ...
     */
    public function columnMax(string $column, null|string $as = null)
    {
        $this->add('columns', [
            'type' => 'column_max',
            'column' => $column,
     ...
     */
    public function rightJoin(string $table, string $first, string $second, $operator = '=')
    {
        $this->add('join', [
            'type' => 'right_join',
            'table' => $table,
